...
@Controller
public abstract class SMSController implements ISMSController
{
	private static final Logger log = Logger.getLogger(SMSController.class.getName());
	...
	public SMSController(CandidateMapper can, String textMessage) 
	{
		super();
		this.can = can;
